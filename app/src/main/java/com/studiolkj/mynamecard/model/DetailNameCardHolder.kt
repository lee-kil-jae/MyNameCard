...
class DetailNameCardHolder: NameCardHolder() {
    ...
    override fun getNameCard(context: Context): ArrayList<Printable>{
        ...
        myNameCardDatas.add(getString("  이길재   [Developer]", DefaultPrinter.ALIGNMENT_CENTER))
        ...
        myNameCardDatas.add(getDivider())
        myNameCardDatas.add(getString("** 개발 분야        ", DefaultPrinter.ALIGNMENT_LEFT))
        myNameCardDatas.add(getString("  - Android, iOS       ", DefaultPrinter.ALIGNMENT_LEFT))
        myNameCardDatas.add(getString("  - Android 기반 주변기기  ", DefaultPrinter.ALIGNMENT_LEFT))
        myNameCardDatas.add(getString("** 개발 언어 (Main)        ", DefaultPrinter.ALIGNMENT_LEFT))
        myNameCardDatas.add(getString("  - Kotlin, Swift, JAVA, C++", DefaultPrinter.ALIGNMENT_LEFT))
        myNameCardDatas.add(getString("** 개발 언어 (Sub)        ", DefaultPrinter.ALIGNMENT_LEFT))
        myNameCardDatas.add(getString("  - Flutter, Python, PHP, node.js", DefaultPrinter.ALIGNMENT_LEFT))
        ...
        myNameCardDatas.add(getString("** 개발 툴        ", DefaultPrinter.ALIGNMENT_LEFT))
        myNameCardDatas.add(getString("  - Android Studio, XCode", DefaultPrinter.ALIGNMENT_LEFT))
        myNameCardDatas.add(getString("  - Eclipse, VSCode", DefaultPrinter.ALIGNMENT_LEFT))
